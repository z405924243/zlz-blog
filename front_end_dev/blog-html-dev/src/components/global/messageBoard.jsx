...
import style from './messageBoard.scss';
...
export default class MessageBoard extends React.Component {
    ...
    setMessageBox() {
        ...
        if (!replyId)
            return (<textarea className={style.textarea} placeholder='畅所欲言吧~' value={this.state.message} onChange={(e) => this.setValue('message', e)}></textarea>);
        ...
        return (
            <div className={style.box}>
                <textarea className={`${style.textarea} ${style.replyTextarea}`} placeholder='畅所欲言吧~' value={this.state.message} onChange={(e) => this.setValue('message', e)}></textarea>
    ...
    sendMessage = () => {
        ...
        axios.post(config.requestUrl + '/insertMsg', params).then(res => {
            ...
            let id = this.props.articleId ? `?id=${this.props.articleId}` : '';
            axios.get(config.requestUrl + '/getMessage' + id).then(res => {
                console.log(res)
